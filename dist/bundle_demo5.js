...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducers = (0, _redux.combineReducers)({ selectChange: _reducer.selectChange });
...
/***/ function(module, exports) {
	...
	function selectChange() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { selectedValue: '' } : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case 'SELECTCHANGE':
	      var newState = Object.assign.apply(Object, [{}].concat(_toConsumableArray(state), [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionCreator = __webpack_require__(203);
	  ...
	  _createClass(Container, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_picker2.default, { value: value, onChange: onChange })
	      );
	    }
	  }]);
	...
	function mapStateToProps(state) {
	  var selectChange = state.selectChange;
	...
	function mapDispatchToProps(dispatch) {
	  var boundActionCreator = (0, _redux.bindActionCreators)(_actionCreator2.default, dispatch);
	  return {
	...
	var PickerContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Container);
...
/***/ function(module, exports) {
	...
	exports.default = selectChangeCreator;
