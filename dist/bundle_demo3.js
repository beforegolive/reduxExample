...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducers = (0, _redux.combineReducers)({ counterReducer: _reducer.counterReducer, secondReducer: _reducer.secondReducer });

	var store = (0, _redux.createStore)(reducers);

	var boundActionCreators = (0, _redux.bindActionCreators)(actionCreators, store.dispatch);
...
/***/ function(module, exports) {
	...
	exports.secondReducer = secondReducer;
	function counterReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { value: 0, otherValue: 0 } : arguments[0];
	  var action = arguments[1];
...
/***/ function(module, exports) {
	...
	exports.incremment = incremment;
	exports.otherIncremment = otherIncremment;
	exports.doubleIncremment = doubleIncremment;
	function incremment() {
	  return {
	    type: 'INCREMENT'
	  };
	...
	function otherIncremment() {
	  return {
	    type: 'OTHER_INCREMENT'
	  };
	}

	function doubleIncremment() {
	  return {
